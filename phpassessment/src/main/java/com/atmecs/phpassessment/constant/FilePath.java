...
public class FilePath {
	...
	public final static String LOCATOR_FILE = LOCATOR_HOME + "phptravleslocators.properties";
	public final static String TESTDATA_FILE = RESOURCES_HOME + "testdata" + File.separator + "phptravlesassessmentdata.xlsx";
